<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MantencionUsuariosCertificadosEditar.aspx.cs" Inherits="Usados_Certificados_MantencionUsuariosCertificadosEditar" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function openCustom() {
            metroDialog.create({
                title: "Información",
                content: "Registro Actualizado Satisfactoriamente!!!",
                actions: [
                            {
                                title: "Ok",
                                onclick: function (el) {
