<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListaRetoma.aspx.cs" Inherits="Usados_Certificados_ListaRetoma" %>
        ...
        <div class="flex-grid no-responsive-future" style="height: 100%;">
            <div class="row" style="height: 100%">
                <div class="cell auto-size padding20 bg-white" id="cell-content">
                    ...
                    <a class="button primary mif-plus" href="FormularioRetoma.aspx" style="font-size: 0.87rem;">
                    Nuevo...</a>
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" EnableModelValidation="True"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Fecha_Retoma" HeaderText="Fecha Retoma" DataFormatString="{0:d}">
                                <ItemStyle Wrap="False" />
                            </asp:BoundField>
                            ...
                            <asp:TemplateField HeaderText="" HeaderStyle-Width="45px">
                                <ItemTemplate>
                                    <a class="button primary fancy3" href="FormularioRetomaEditar.aspx?id=<%# Eval("ID") %>">
                    ...
                    <%--<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SAP_WEBConnectionString %>"
                        SelectCommand="Sp_Lst_Consulta_Usados_Retoma "></asp:SqlDataSource>--%>
                </div>
            </div>
        </div>
    </div>
