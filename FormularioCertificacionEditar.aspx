<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FormularioCertificacionEditar.aspx.cs" Inherits="Usados_Certificados_FormularioCertificacionEditar" %>
            ...
            <table cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        ...
                        <div class="input-control text" data-role="input-control">
                            <input type="text" class="validar" placeholder="" id="txtKmsActual" maxlength="10" runat="server" style="margin-left: 19px;" readonly="readonly" />
                        </div>
                    </td>
                </tr>
                <tr>
...
<%--                <tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <textarea maxlength="500" style="height: 70px; -ms-overflow-y: hidden; width: 100%; margin-left: -70px;" runat="server" id="txtComentarios" readonly="readonly"></textarea>
                    </td>
                </tr>
                <tr>
                    <td>
                        ...
                        <div class="input-control text" data-role="input-control">
                            <input type="text" placeholder="" id="txtOT" maxlength="10" runat="server" style="margin-left: 1px;" readonly="readonly" />
                        </div>
                    </td>
                </tr>
            </table>
            <table>
                <tr>
                    ...
                    <%--<td>Aprobar<button class="button success cycle-button" style="margin-left: 190px;" id="btn_Aprobar" runat="server" onserverclick="btn_Aprobar_Click"><span class="icon mif-event-available"></span></button></td>
                    <td>Rechazar<button class="button danger cycle-button" id="btn_Rechazar" runat="server" onserverclick="btn_Rechazar_Click"><span class="icon mif-cross"></span></button></td>--%>
                    <td>
                    <button class="image-button primary" style="margin-left: 125px;" id="Button2" runat="server" onserverclick="btn_Ver_Click">
                        Ver Detalle...
                        <span class="icon mif-list-numbered bg-darkCobalt"></span>
                    </button>
                    </td>
            ...
            <table border="1">
                ...
                <tr>
                    <td>
                        <center>
                            <input type="checkbox" checked="false" runat="server" id="chk30d" disabled="disabled"/>
                            <span class="check"></span>
                        </center>
                    </td>
                    <td>
                        <center>
                            <input type="checkbox" checked="false" runat="server" id="chk10k" disabled="disabled"/>
                            <span class="check"></span>
                        </center>
                    </td>
                    <td>
                        <center>
                            <input type="checkbox" checked="false" runat="server" id="chk20k" disabled="disabled"/>
                            <span class="check"></span>
                        </center>
                    </td>
                    <td>
                        <center>
                            <input type="checkbox" checked="false" runat="server" id="chk30k" disabled="disabled"/>
                            <span class="check"></span>
                        </center>
                    </td>
                    <td>
                        <center>
                            <input type="checkbox" checked="false" runat="server" id="chk40k" disabled="disabled"/>
                            <span class="check"></span>
                        </center>
                    </td>
                    <td>
                        <center>
                            <input type="checkbox" checked="false" runat="server" id="chk50k" disabled="disabled"/>
                            <span class="check"></span>
                        </center>
                    </td>
                    <td>
                        <center>
                            <input type="checkbox" checked="false" runat="server" id="chk60k" disabled="disabled"/>
                            <span class="check"></span>
                        </center>
                    </td>
                    <td>
                        <center>
                            <input type="checkbox" checked="false" runat="server" id="chk70k" disabled="disabled"/>
                            <span class="check"></span>
                        </center>
                    </td>
                    <td>
                        <center>
                            <input type="checkbox" checked="false" runat="server" id="chk80k" disabled="disabled"/>
                            <span class="check"></span>
                        </center>
                    </td>
                    <td>
                        <center>
                            <input type="checkbox" checked="false" runat="server" id="chk90k" disabled="disabled"/>
                            <span class="check"></span>
                        </center>
                    </td>
                </tr>
            ...
            <center>
                <table cellspacing="0" cellpadding="0">
                    <tr>
                        <td><label class="input-control radio small-check" runat="server" id="aprob">
                            <input name="n3" type="radio" runat="server" id="rb_aprobar"/>
                            <span class="check"></span>
                            <span class="caption">Aprobar</span>
                        </label></td>
                        <td><label class="input-control radio small-check" runat="server" id="rechaz">
                            <input name="n3" type="radio" runat="server" id="rb_rechazar"/>
                            <span class="check"></span>
                            <span class="caption">Rechazar</span>
                        </label></td>
                    </tr>
                </table>
            </center>
