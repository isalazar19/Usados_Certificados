<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FormularioRetoma.aspx.cs" Inherits="Usados_Certificados_FormularioRetoma" %>
    ...
    <script type="text/javascript">
        ...
        function validarSiNumero(numero){
            if (!/^([0-9])*$/.test(numero))
                ...
                setTimeout(function () {
                    $.Notify({ type: 'warning', caption: 'Aviso', content: "El valor del Precio Retoma o Precio Medio " + numero + " no es un número", icon: "<span class='mif-warning'></span>" });
                }, 3000);
        }
...
<body>
    ...
    <div>
        ...
        <div class="tabcontrol2" data-role="tabcontrol" id="tabs">
            <ul class="tabs">
                <li><a href="#frame_5_1">Datos del Cliente</a></li>
                                    ...
                                    <div class="row cells2">
                                        <div class="cell">
                                            ...
                                            <div class="input-control text" data-role="input">
                                                <input type="text" placeholder="" id="txtRut" maxlength="12" runat="server" onkeyup="formatCliente(this)" >
                ...
                <div class="frame" id="frame_5_2" >
                    <div class="span12">
                        <fieldset style="border: 1px solid #999; border-radius: 8px; box-shadow:0 0 10px #999;"">
                                ...
                                <div class="grid">
                                    <div class="row cells2">
                                        <div class="cell">
                                            ...
                                            <div class="input-control text" data-role="input">
                                                <input type="text" placeholder="" id="txtNumStock" maxlength="10" runat="server" >
                            ...
                            <asp:GridView id="GridViewMantenciones" CssClass="table striped hovered cell-hovered border bordered" runat="server" Width="98%" Font-Names="Arial" ForeColor="#333333" CellSpacing="1" CellPadding="3" GridLines="None" DataKeyNames="VehSto,RevNumero" __designer:wfdid="w76" AutoGenerateColumns="False" OnRowDataBound="GridViewMantenciones_RowDataBound" AllowSorting="True" PageSize="4">
                                ...
                                <Columns>
                                    ...
                                    <div class="row cells2">
                                        <div class="cell">
                                            ...
                                            <asp:GridView id="GridViewDYP" CssClass="table striped hovered cell-hovered border bordered" runat="server" Width="98%" Font-Names="Arial" ForeColor="#333333" CellSpacing="1" CellPadding="3" GridLines="None" __designer:wfdid="w80" AutoGenerateColumns="False" OnRowDataBound="GridViewDYP_RowDataBound" AllowSorting="True" PageSize="3">
                                    ...
                                    <div class="row cells2">
                                        <div class="cell">
                                            ...
                                            <div class="input-control text" data-role="datepicker" data-week-start="1">
                                                ...
                                                <button class="button" type="button" runat="server" id="btnCalendar"><span class="mif-calendar"></span></button>
                                            </div>
                                        </div>
                                        <div class="cell">
                                            <label style="text-align: left;">Precio Retoma</label>
                                            <div class="input-control text" data-role="input-control">
                                                <input type="text" placeholder="" id="txtPrecioRetoma" maxlength="10" runat="server" onchange="validarSiNumero(this.value);" />
                                            </div>
                                        </div>
                                        <div class="cell">
