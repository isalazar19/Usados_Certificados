<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FormularioReventa.aspx.cs" Inherits="Usados_Certificados_FormularioReventa" %>
                ...
                <div class="grid">
                    <div class="row cells4">
                        ...
                        <div class="cell">
                            ...
                            <div class="input-control text" data-role="input-control">
                                <input type="text" placeholder="" id="txtPrecioVenta" maxlength="10" runat="server" onchange="validarSiNumero(this.value);" onblur="CalcularDifPrecio();" />
                            </div>
                        </div>
                        <div class="cell">
